          ...
          <div className="p-4 sm:p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600 mt-1">Manage your gym operations</p>
              </div>
              <button
                onClick={() => setSidebarOpen(false)}
            ...
            <div className="space-y-1">
              {navigationItems.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center px-4 sm:px-6 py-3 sm:py-4 text-left text-sm font-medium transition-colors touch-manipulation ${
            ...
            <div className="flex items-center justify-between px-4 sm:px-6 py-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-4 ml-4">
                <span className="text-sm sm:text-base text-gray-600 hidden sm:inline">
                  Welcome back, <span className="font-semibold text-blue-600">{userProfile?.full_name}</span>
                </span>
                <span className="text-sm text-gray-600 sm:hidden">
                  Hi, <span className="font-semibold text-blue-600">{userProfile?.full_name}</span>
                </span>
                <button
                  onClick={signOut}
