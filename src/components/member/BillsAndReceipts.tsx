      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        {bills.length === 0 ? (
          <div className="px-6 py-12 text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900">No bills and receipts</h3>
            <p className="mt-2 text-sm text-gray-500">
              You don't have any bills or receipts yet. Bills will appear here once your membership is processed or when you make purchases.
            </p>
            <div className="mt-6">
              <div className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-blue-600 bg-blue-100">
                ...
                New member? Your first bill will be generated soon!
              </div>
            </div>
          </div>
        ) : (
